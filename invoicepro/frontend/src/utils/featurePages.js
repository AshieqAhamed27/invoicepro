export const featurePages = {
  ...
  'devops-delivery': {
    ...
    benefit: 'Helps technical freelancers launch and hand over client projects.',
    ...
    problem: 'Technical freelancers can finish the work but still lose trust during deployment, server access, release proof, SSL, backup, handover, and maintenance planning.',
    ...
    bestFor: 'Technical freelancers, website builders, IT providers, developers, and small agencies.',
