      ...
      <main className="container-custom py-10 md:py-16">
        <div className="reveal mb-12">
          <div className="flex items-center gap-2 mb-4">
             ...
             <p className="text-[10px] font-black uppercase tracking-widest text-yellow-400">Merchant Settings</p>
          </div>
          ...
          <p className="max-w-2xl text-lg text-zinc-500 font-medium leading-relaxed">
            Configure your professional workspace and business identity.
          </p>
        </div>
        ...
        >
          <div className="reveal reveal-delay-1 space-y-8">
            <section className="surface p-8 border-white/5 bg-zinc-950/40 backdrop-blur-xl rounded-[2.5rem] relative overflow-hidden group">
              <div className="mb-8">
                <h2 className="text-2xl font-black text-white leading-none mb-1">Corporate Identity</h2>
                <p className="text-xs font-bold text-zinc-500 uppercase tracking-widest">Global branding details</p>
              </div>
            ...
            <section className="surface p-8 border-white/5 bg-zinc-950/40 backdrop-blur-xl rounded-[2.5rem]">
              <div className="mb-8">
                <h2 className="text-2xl font-black text-white leading-none mb-1">Finance Hub</h2>
                <p className="text-xs font-bold text-zinc-500 uppercase tracking-widest">Payment settlement routes</p>
              </div>
            ...
            <section className="surface p-8 border-white/5 bg-zinc-950/40 backdrop-blur-xl rounded-[2.5rem]">
              <div className="mb-8">
                <h2 className="text-2xl font-black text-white leading-none mb-1">HQ Address</h2>
                <p className="text-xs font-bold text-zinc-500 uppercase tracking-widest">Displayed on all legal documents</p>
              </div>
            ...
            <section className="surface p-8 border-white/5 bg-zinc-950/40 backdrop-blur-xl rounded-[2.5rem]">
              <div className="mb-8">
                <h2 className="text-2xl font-black text-white leading-none mb-1">Asset Library</h2>
                <p className="text-xs font-bold text-zinc-500 uppercase tracking-widest">Branding and assets</p>
              </div>
          ...
          <aside className="reveal reveal-delay-2 space-y-6 lg:sticky lg:top-28 h-fit">
            <div className="surface p-8 border-white/10 bg-zinc-950 shadow-2xl rounded-[2.5rem] relative overflow-hidden group">
              ...
              >
                {saving ? 'Encrypting...' : 'Deploy Changes'}
              </button>
            </div>
            ...
            <div className="p-6 rounded-2xl border border-white/5 bg-white/[0.01]">
               <p className="text-xs font-medium text-zinc-500 leading-relaxed italic">
                 Changes made here will be applied to all future invoices generated by your workspace. Existing invoices will maintain their original data.
               </p>
            </div>
          </aside>
        </form>
