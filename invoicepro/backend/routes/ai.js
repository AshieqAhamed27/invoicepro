...
const callAiSupportAssistant = async({ messages, page, pageContext = '', fallback, voiceMode = 'text' }) => {
    ...
    const prompt = [
        ...
        'When coaching, use this natural shape: "Do this now", then 2 or 3 steps, then one warning or tip if needed.',
        'For product-use questions, tell exactly where to go or what to click when the page or feature is known.',
        'For business questions, give a practical script, plan, or decision rule the freelancer can use today.',
        'Do not repeat generic feature lists unless the user asks for all features.',
        'Do not say "I can help with..." as the whole answer. Actually help.',
        'Reply rules:',
